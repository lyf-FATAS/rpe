...
namespace RPE
{
    ...
    extern vector<cv::KeyPoint> kps1_l_outliers_stereo, kps2_l_outliers_stereo;
    extern vector<cv::KeyPoint> kps1_l_outliers_gnc, kps2_l_outliers_gnc;
    extern vector<cv::KeyPoint> kps1_l_refined, kps2_l_refined;
    extern vector<cv::KeyPoint> kps1_l_outliers_refined_gnc, kps2_l_outliers_refined_gnc;
    ...
    extern vector<Matrix3d> R12_debug;
    extern vector<Vector3d> t12_debug;
}